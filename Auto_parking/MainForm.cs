...
namespace Auto_parking
{
    public partial class MainForm : Form
    {
        ...
        {
            InitializeComponent();
            stream = new MJPEGStream("http://192.168.137.207:81/");
        ...
        */
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            cbCom.Items.AddRange(lports);
            try
            {
                capture = new Emgu.CV.Capture();
                //capFace = new Emgu.CV.Capture();
            }
            catch { }
            ...
            if (success == true)
            {
                ...
                new Thread(() =>
                {
                    try
                    {
                        ...
                        //Image<Bgr, byte> cap = capFace.QueryFrame();
                        if (cap != null)
                        {
                            MethodInvoker mi = delegate
                            {
                                try
                                {
                                    ...
                                    //Face
                                    //Bitmap bmp1 = cap1.ToBitmap();
                                    //pictureBox_WC.Image = bmp1;
                                    //IF.pictureBox4.Image = bmp;
                                    //pictureBox_WC.Update();
                                    //IF.pictureBox4.Update();
                                }
        ...
        #region Process and Detect Image
        ...
        private void regonizeBtn_Click(object sender, EventArgs e)
        {
            ...
            pictureBox_CarOut.Image = temp1;
            if (temp3 == "")
                text_PlateOut.Text = "ko nhận dạng dc biển số";
            else
                text_PlateOut.Text = temp3;
        }
        ...
        private void capCameraBtn_Click(object sender, EventArgs e)
        {
            ...
            if (capture != null)
            {
                ...
                //Reconize("E:/Auto_parking/Image/test.bmp", out temp1, out temp2, out temp3);
                pictureBox_CarOut.Image = temp1;
                if (temp3 == "")
                    text_PlateOut.Text = "ko nhận dạng dc biển số";
                else
        ...
        private void pictureBox_CarOut_Click(object sender, EventArgs e)
        {
        ...
        private void pictureBox_WC_Click(object sender, EventArgs e)
        {
